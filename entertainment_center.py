""" PLEASE NOTE TO KEEP "entertainment_center.py", "fresh_tomato.py"
    & "media.py" in same directory for working of the project."""

import fresh_tomato
# imports the website design using fresh_tomato.py
import media
# imports media.py where the class file is defined

""" Followings are the List of Movies as "objects" of "class"
    in "media.py" are defined with their unique variables"""

dalgal = media.Movie("Dangal",
                     "Story abount a man of making" +
...
a_wednesday = media.Movie("A Wednesday",
                          ...
                          "/7/77/A_Wednesday_Poster.JPG/" +
                          "220px-A_Wednesday_Poster.JPG",
...
taare_zameen_par = media.Movie("Taare Zameen Par",
                               ...
                               "b4/Taare_Zameen_Par_Like_Stars_on_Earth_" +
                               "poster.png",
                               "https://www.youtube.com/watch?v=qLsiGq-aC88")


movies = [dalgal, a_wednesday, titanic, three_idiots, swades, taare_zameen_par]
# List of movies' variable
fresh_tomato.open_movies_page(movies)
# Open the Processed Website
